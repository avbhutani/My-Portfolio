      ...
      <section>
        <div id="education-section">
          ...
          <EducationalDetails
            grade="CGPA: 9.70"
            session="2021-2025"
            stage="Undergraduation"
            instituteName="SRM INSTITUTE OF SCIENCE AND TECHNOLOGY, CHENNAI, TAMIL NADU"
          />
          <EducationalDetails
            grade="Percentage: 93.4%"
            session="2020-2021"
            stage="Class 12"
            instituteName="DAV PUBLIC SCHOOL SECTOR 48, 49 GURGAON, HARYANA"
          />
          <EducationalDetails
            grade="Percentage: 94%"
            session="2018-2019"
